# bazel-intellij-private
Internal client tooling fork of https://github.com/bazelbuild/intellij for Android

## Branches

- master is bazelbuild/intellij master
- main is the internal bazel-intellij-private main that plugins are built from.

## To Build

bazel build //aswb:aswb_bazel_zip --define=ij_product=android-studio-2020.3

Make sure you override the version in version.bzl

### Upstream README following...
